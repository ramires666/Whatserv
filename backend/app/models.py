...
class Account(TimestampMixin, Base):
    ...
    login_email: Mapped[str | None] = mapped_column(String(254), unique=True, index=True)
    ...
    wa_display_name: Mapped[str | None] = mapped_column(String(120))
    wa_logout_command_id: Mapped[str | None] = mapped_column(String(36), unique=True)
